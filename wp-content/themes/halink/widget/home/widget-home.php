        ...
        <p>
            ...
            <select name="<?= $this->get_field_name('page'); ?>" id="<?= $this->get_field_id('page'); ?>" style='width:50%;margin-left:5px'>
                ...
                while ( $query->have_posts() ) : $query->the_post();
                    ...
                    echo "<option value=\"" . $id . "\" $sl>" . get_the_title() . "</option>";
                ?>                
                <?php endwhile; ?>
            </select>
        </p>
                            ...
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                                    ...
                                                    <strong>
                                                        <span style="font-family: tahoma, arial, helvetica, sans-serif;">
                                                            <span style="color: #58925b;">
                                                                <a style="color: #58925b;" href="index.html"><?php  ?></a>
                                                            </span>
                                                        </span>
                                                    </strong>
                                                </span>
                                    ...
                                    <div class=" ubtn-ctn-left ">
                                        <a class="ubtn-link ult-adjust-bottom-margin ubtn-left ubtn-custom" rel='' href="gioi-thieu/index.html">
